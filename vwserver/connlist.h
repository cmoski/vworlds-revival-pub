...
class CConnList : public CVWMap<IVWCommConnection *,IVWCommConnection *,ConnectionInfo,ConnectionInfo&>
{
public:
	CConnList();
	~CConnList();
	...
	BOOL		AddConnection(IVWCommConnection *pCommConnection, IWorld *pWorld, IVWComm *vwcomm);
};
