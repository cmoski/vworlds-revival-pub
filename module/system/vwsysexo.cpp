...
#include "vwutils.h"
#include "syshelp.h"
// wpapi.h (Web Publishing API) removed from modern SDK
// The code loads WpPost dynamically via GetProcAddress, so no header needed
#ifndef WPF_NO_RECURSIVE_POST
#define WPF_NO_RECURSIVE_POST 0x00000002
#endif
#include <reghelp.h>
#include <vwevents.h>
#include <vwanim.h>
