========================================================================
		OLE Control DLL : VWVIEW
========================================================================

ControlWizard has created this project for your VWVIEW OLE Control DLL,
...
that make up your VWVIEW OLE Control DLL.
...
ViewCtl.h
	This file contains the declaration of the CVWViewCtrl C++ class.

ViewCtl.cpp
	This file contains the implementation of the CVWViewCtrl C++ class.

ViewPpg.h
	This file contains the declaration of the CVWViewPropPage C++ class.

ViewPpg.cpp
	This file contains the implementation of the CVWViewPropPage C++ class.

ViewCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CVWViewCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file VWView.rc.
